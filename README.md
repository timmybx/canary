...
- `data/raw/software_heritage_api/<plugin>.swh.json` and `data/raw/software_heritage_athena/<plugin>.swh_athena.json` — Software Heritage metadata from API and Athena backends
