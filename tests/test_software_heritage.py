"""
Behavior tests for canary.collectors.software_heritage.

Consolidates test_software_heritage{,_extra}.py.
"""
...
def _write_plugin_snapshot(data_dir: Path, plugin_id: str, snap: object) -> None:
