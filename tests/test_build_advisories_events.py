"""
Behavior tests for canary.build.advisories_events: normalizing per-plugin
advisory JSONL files into a single deduped, sorted events stream.

Consolidates test_build_advisories_events{,_extra}.py.
"""
