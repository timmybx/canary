...
Results from the final run (June 2026, top-8000 universe):
...
| Random Forest | PyPI | 0.1597 | 0.6797 | 0.800 | 0.600 |
| Logistic | Jenkins | 0.0253 | 0.5034 | 0.000 | 0.000 |
| Logistic | PyPI | 0.2288 | 0.7762 | 0.400 | 0.360 |
...
The P@10 = 1.000 result for XGBoost indicates the ten highest-scored packages
were all true positives.
